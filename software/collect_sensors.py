...
def run_collection(i2c, t_wake = 30):
    ...
    perc = battery.get_percentage(values['volt'], lb = 3.4, ub = 4.3) # map voltage from 3.4..4.3 V to 0..100%

    time.sleep_ms(5000 - (time.ticks_ms() - t_start))               # sleep for the specified 5 seconds (remaining)
